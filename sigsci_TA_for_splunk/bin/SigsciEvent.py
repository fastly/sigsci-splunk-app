...
'''
    ...
    Add your modular input logic to file SigsciEvent.py
'''
class ModInputSigsciEvent(modinput_wrapper.base_modinput.SingleInstanceModInput):

    def __init__(self):
        super(ModInputSigsciEvent, self).__init__("sigsci_ta_for_splunk", "SigsciEvent")
